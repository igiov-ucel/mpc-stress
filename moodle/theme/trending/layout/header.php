<?php
   ...
   $html = theme_trending_get_html_for_settings($OUTPUT, $PAGE);
   // General Settings
   ...
   if (!empty($PAGE->theme->settings->copyright)) {
   	...
   	if (!empty($PAGE->theme->settings->backtotop)) {
   	          $PAGE->requires->js('/theme/trending/yui/bttotop.js');
   	}
...
<html <?php echo $OUTPUT->htmlattributes(); ?>>
   <head>
      ...
      <style>
         ...
         src: url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/BebasNeueBold_gdi.eot');
         src: url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/BebasNeueBold_gdi.eot?#iefix') format('embedded-opentype'),
         url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/BebasNeueBold_gdi.woff') format('woff'),
         url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/BebasNeueBold_gdi.ttf') format('truetype'),
         url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/BebasNeueBold_gdi.otf') format('opentype'),
         url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/BebasNeueBold_gdi.svg#BebasNeueBold-Regular') format('svg');
         font-weight: 700;
         font-style: normal;
         font-stretch: normal;
         ...
         src: url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/fontawesome-webfont.eot?v=4.7.0');
         src: url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/fontawesome-webfont.eot?#iefix&v=4.7.0') format('embedded-opentype'), url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/fontawesome-webfont.woff2?v=4.7.0') format('woff2'), url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/fontawesome-webfont.woff?v=4.7.0') format('woff'), url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/fontawesome-webfont.ttf?v=4.7.0') format('truetype'), url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/fontawesome-webfont.svg?v=4.7.0#fontawesomeregular') format('svg');
         font-weight: normal;
         font-style: normal;
         }
         @font-face {
         font-family: 'route_159regular';
         src: url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/route159-regular-webfont.woff2') format('woff2'),
         url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/route159-regular-webfont.woff') format('woff'),
         url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/route159-regular-webfont.ttf') format('truetype'),
         url('<?php echo $CFG->wwwroot ?>/theme/trending/fonts/route159-regular-webfont.svg#route_159regular') format('svg');
         font-weight: normal;
         font-style: normal;
         }
      </style>
