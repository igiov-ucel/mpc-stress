      ...
      <div class="colorful-tab-wrapper active" id="colorful-background-image">
         <div class="colorful-tab-list-section clearfix">
            <ul class="colorful-tab-menu">
               <li class="colorful-tab-menu-item active" tab-background="<?php echo $student1backgroundurl ?>"><a class="student-a" href="#bg-0"><?php echo $student1name ?></a></li>
               <li class="colorful-tab-menu-item tab-menu-one" tab-background="<?php echo $student2backgroundurl ?>"><a class="student-b" href="#bg-1"><?php echo $student2name ?></a></li>
               <li class="colorful-tab-menu-item tab-menu-two" tab-background="<?php echo $student3backgroundurl ?>"><a class="student-c" href="#bg-2"><?php echo $student3name ?></a></li>
               <li class="colorful-tab-menu-item" tab-background="<?php echo $student4backgroundurl ?>"><a class="student-d" href="#bg-3"><?php echo $student4name ?></a></li>
               <li class="colorful-tab-menu-item" tab-background="<?php echo $student5backgroundurl ?>"><a class="student-e" href="#bg-4"><?php echo $student5name ?></a></li>
            </ul>
         </div>
